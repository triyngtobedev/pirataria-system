...
App._doNavigate = function(module) {
  ...
  var renderers = { hoje: 'renderHoje', inbox: 'renderInbox', orcamentos: 'renderOrcamentos', marketing: 'renderMarketing', conhecimento: 'renderConhecimento', aihub: 'renderAIHub', agenda: 'renderAgenda', clientes: 'renderClientes', atendimento: 'renderAtendimento', studio: 'renderStudio', relatorios: 'renderRelatorios', estoque: 'renderEstoque', financeiro: 'renderFinanceiro', os: 'renderOS', termos: 'renderTermos', lembretes: 'renderLembretes', comissoes: 'renderComissoes', vales: 'renderVales', pacotes: 'renderPacotes' };
