const Permissions = {
  _rules: {
    admin: {
      modules: ['hoje', 'inbox', 'orcamentos', 'oportunidades', 'filas', 'marketing', 'conhecimento', 'aihub', 'agenda', 'clientes', 'atendimento', 'financeiro', 'estoque', 'relatorios', 'studio', 'os', 'termos', 'lembretes', 'comissoes', 'vales', 'pacotes'],
      canManageUsers: true,
